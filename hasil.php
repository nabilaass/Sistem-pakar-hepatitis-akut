...
<html lang="en">
  <head>
    ...
    <meta name="author" content= "SISTEM PAKAR DIAGNOSA PENYAKIT HEPATITIS AKUT | www.artificial intelligence.com">
    <link rel="icon" href="">

    <title>SISTEM PAKAR DIAGNOSA PENYAKIT HEPATITIS AKUT | www.artificial intelligence.com</title>
 ...
 {    
  ...
  $sql = mysqli_query($koneksi, "SELECT pencegahan.*, penyakit.*, solusi.*, rule.* 
			...
			if(mysqli_num_rows($sql) == 0){
		     header('location:diagnosa.php?error=Tidak ditemukan penyakit dengan gejala tersebut disini, silahkan ulangi <a href="diagnosa.php">disini</a>');		
          	}else{
...
<!-- end Modal Popup -->
      ...
      <!-- Site footer -->
      <footer class="footer">
        <p>Copyright &copy; 2022 <a href="#"> www.artificial intelligence.com</a></p>
      </footer>
